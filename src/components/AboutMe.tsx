...
const AboutMe = () => (
  <section id="about" className="scroll-mt-20 border-y border-border bg-card py-16 sm:py-24">
    <div className="section-shell grid gap-8 lg:grid-cols-[.75fr_1.25fr] lg:gap-10">
      <div><p className="eyebrow mb-3">About</p><h2 className="font-display text-3xl font-medium sm:text-5xl">Software that respects the operation.</h2></div>
      <div>
        <p className="font-display text-xl leading-relaxed sm:text-3xl">I link physical warehouse activity to dependable software—understanding the workflow before shaping the system around it.</p>
