          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 space-y-6">
              <h1 className="text-5xl md:text-6xl font-bold leading-tight">
                Full-Stack Software Developer | <span className="text-primary">Warehouse Logistics Systems</span>
              </h1>
              ...
              <div className="space-y-4">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  ...
                  system modernisation skills to every project. From legacy system transformations to international logistics solutions, 
                  I build robust, scalable systems that power multi-million pound warehouse operations.
                </p>
              </div>
